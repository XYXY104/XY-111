...
local function playSound()
    if soundEnabled then
        pcall(function()
            ...
            sound.SoundId = "rbxassetid://90514823373955"
            sound.Volume = 0.3
...
local chatSystem = {
    ...
    chatModes = {
        ...
        ["宣传词"] = function() return {"XY脚本牛逼", "打败一切", "快来购买", "功能多多", "支持超多服务器"} end
    },
    connections = {},
    active = false
}
...
local function changeWeather(weatherType)
    ...
    if weatherType == "Rainy" then
        ...
        rain.Texture = "rbxassetid://136059273188532"
...
local skySettings = {
    ["神秘"] = "http://www.roblox.com/asset/?id=90514823373955",
    ["不要点我"] = "http://www.roblox.com/asset/?id=136059273188532",
    ["动漫猫羽雫天空"] = "http://www.roblox.com/asset/?id=16060333448"
}

local selectedSky = "神秘"
...
Settings:Button({
    ...
    Callback = function()
        ...
        setclipboard("XY脚本 V2 设置: " .. game:GetService("HttpService"):JSONEncode(settings))
        playSound()
    end
})
